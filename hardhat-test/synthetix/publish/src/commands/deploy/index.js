...
const { loadCompiledFiles } = require('../../solidity.js');
...
const { performTransactionalStep } = require('../../command-utils/transact.js');

const {
	constants: { BUILD_FOLDER, CONFIG_FILENAME, SYNTHS_FILENAME, DEPLOYMENT_FILENAME },
} = require('../../../..');

const addSynthsToProtocol = require('./add-synths-to-protocol.js');
const configureLegacySettings = require('./configure-legacy-settings.js');
const configureRewardEscrow = require('./configure-reward-escrow.js');
const configureLoans = require('./configure-loans.js');
const configureStandalonePriceFeeds = require('./configure-standalone-price-feeds.js');
const configureOffchainPriceFeeds = require('./configure-offchain-price-feeds.js');
const configureSynths = require('./configure-synths.js');
const configureFutures = require('./configure-futures.js');
const configureSystemSettings = require('./configure-system-settings.js');
const deployCore = require('./deploy-core.js');
const deployDappUtils = require('./deploy-dapp-utils.js');
const deployLoans = require('./deploy-loans.js');
const deploySynths = require('./deploy-synths.js');
const deployFutures = require('./deploy-futures.js');
const {
	deployPerpsV2Generics,
	deployPerpsV2Markets,
	cleanupPerpsV2,
	configurePerpsV2GenericParams,
} = require('./deploy-perpsv2.js');
const generateSolidityOutput = require('./generate-solidity-output.js');
const getDeployParameterFactory = require('./get-deploy-parameter-factory.js');
const importAddresses = require('./import-addresses.js');
const importFeePeriods = require('./import-fee-periods.js');
const importExcludedDebt = require('./import-excluded-debt.js');
const performSafetyChecks = require('./perform-safety-checks.js');
const rebuildResolverCaches = require('./rebuild-resolver-caches.js');
const rebuildLegacyResolverCaches = require('./rebuild-legacy-resolver-caches.js');
const systemAndParameterCheck = require('./system-and-parameter-check.js');
